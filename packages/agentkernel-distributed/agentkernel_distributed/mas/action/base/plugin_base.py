...
class ActionPlugin(ABC):
    ...
    async def init(
        ...
        Args:
            model_router (Optional[ModelRouter], optional): Handle to the model router, allowing plugins to make calls to models.
            controller (Optional["BaseController"], optional): Handle to the main controller, providing plugins access to other module.
        """
...
class MCPToolPlugin(ActionPlugin):
    ...
    async def __aexit__(
        ...
        Args:
            exc_type (Optional[Type[BaseException]], optional): Exception type raised within the context.
            exc_val (Optional[BaseException], optional): Exception instance raised within the context.
            exc_tb (Optional[TracebackType], optional): Traceback information for the exception.
        """
